...
function atualizarRelatorio() {
  ...
  const html = `<div class="print-report"><h1>Fusion Sistema - Avaliação Física</h1>
...
/* Fusion Sistema 2.7.6 P1 — IA de Avaliação Física por Voz */
...
/* Fusion Sistema 2.7.6 P2B — Avaliação Física Mobile */
(function(){
...
// Fusion Sistema — proteção visual extra para avaliação no Portal Professor
if (PORTAL_PROFESSOR) {
  document.addEventListener('DOMContentLoaded', () => document.body.classList.add('modo-professor-avaliacao'));
}

// Fusion Sistema v5 — liga botões após carregar a tela sem quebrar o script principal.
