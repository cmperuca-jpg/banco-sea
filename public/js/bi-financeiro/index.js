...
const chartPalette = ['#38bdf8', '#fb7185', '#eab308', '#34d399', '#a78bfa', '#22b8d2'];
  ...
  graficos[id] = new Chart(canvas, {
    ...
    data: {
      ...
      datasets: [
        ...
        { label: 'Saldo', data: dados.map(x => x.saldo), borderColor: '#eab308', backgroundColor: 'rgba(234, 179, 8, 0.12)', tension: 0.28, pointRadius: 3 }
      ]
    },
