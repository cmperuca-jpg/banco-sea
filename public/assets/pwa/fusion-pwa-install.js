(() => {
  ...
  style.textContent = `
    ...
    .fusion-pwa-banner div{display:grid;gap:3px;flex:1}.fusion-pwa-banner span,.fusion-ios-hint span{font-size:13px;color:#d1d5db}.fusion-pwa-banner button,.fusion-ios-hint button{border:0;border-radius:10px;padding:9px 11px;font-weight:800;cursor:pointer}.fusion-pwa-banner [data-pwa-install]{background:var(--fusion-pwa-color,#22b8d2);color:#fff}.fusion-pwa-banner [data-pwa-close],.fusion-ios-hint button{background:#e5e7eb;color:#111827}@media(max-width:560px){.fusion-pwa-banner{align-items:stretch;display:grid}.fusion-pwa-banner button{width:100%}}
  `;
