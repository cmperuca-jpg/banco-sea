...
function Show-AccessPopup($Data) {
  ...
  elseif ($tipo -eq "nao_encontrada") { $cor = [Drawing.Color]::FromArgb(184, 160, 0) }
...
Write-Host "O LED será mantido ativo pelas chamadas contínuas /capturar-acesso do Fusion Sistema."
