...
Write-Host "Fusion Sistema Mobile 2.7.4" -ForegroundColor Cyan
Write-Host "Destino: $TargetRoot"
if (-not (Test-Path (Join-Path $TargetRoot 'package.json'))) { throw 'Execute este instalador dentro da pasta raiz do Fusion Sistema, onde fica o package.json.' }
