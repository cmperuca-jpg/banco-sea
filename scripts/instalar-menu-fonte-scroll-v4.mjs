...
/* === Fusion Sistema Menu Global v4: fonte, tamanho e scroll fixos === */
:root{
...
css = css.replace(/\/\* === Fusion Sistema Menu Global v4:[\s\S]*?body \.fusion-sidebar \.fusion-sidebar-footer\{[\s\S]*?\}\s*/g, '');
if (!css.includes('Fusion Sistema Menu Global v4')) css += cssPatch;
