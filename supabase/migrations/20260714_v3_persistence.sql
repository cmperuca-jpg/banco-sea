...
comment on table public.fusion_v3_records is 'Persistência JSONB compatível da transição Fusion Sistema 3.0. Acesso exclusivo pelo backend com service_role.';
